...
final class MinecraftOpenGLStageScope implements BackendStageScope {
    private final GLStateSnapshot snapshot;
    private final OpenGLStateAccess stateAccess;
    private final GraphicsAPI api;

    MinecraftOpenGLStageScope(GLStateSnapshot snapshot, OpenGLStateAccess stateAccess, GraphicsAPI api) {
