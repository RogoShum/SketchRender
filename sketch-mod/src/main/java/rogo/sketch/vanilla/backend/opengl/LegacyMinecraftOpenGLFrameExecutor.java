...
final class LegacyMinecraftOpenGLFrameExecutor implements BackendFrameExecutor {
    private final GraphicsAPI api;
    private final BackendFrameExecutor delegate;
    private final OpenGLStateAccess stateAccess;

    LegacyMinecraftOpenGLFrameExecutor(GraphicsAPI api, BackendFrameExecutor delegate, OpenGLStateAccess stateAccess) {
        this.api = api;
    ...
    public <C extends RenderContext> BackendStageScope beginExecutionScope(
        ...
        return new LegacyMinecraftStageScope(snapshot, stateAccess, api);
    }
