...
public class FunctionCommand extends RenderCommand {
    ...
    private final List<FunctionGraphics> functions;

    public FunctionCommand(RenderSetting renderSetting, ResourceBinding resourceBinding, KeyId stageId, List<UniformBatchGroup> uniformBatches, List<FunctionGraphics> functions) {
    ...
    public void execute(RenderContext context) {
        for (FunctionGraphics function : functions) {
