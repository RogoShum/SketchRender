...
/**
 * Compiles sparse authoring overrides into complete runtime state groups.
 */
public final class RenderStateCompiler {
    private RenderStateCompiler() {
    }

    public static CompiledRenderState compile(RenderStatePatch patch) {
        ...
        return new CompiledRenderState(
                resolvedPatch,
