...
public class RenderBatch<T extends InstanceInfo<?>> {
    ...
    // Ordering metadata populated by merged container visibility pass
    private long firstVisibleOrderKey = Long.MAX_VALUE;
    private long visibleRevision = 0L;
    ...
    public long getFirstVisibleOrderKey() {
        return firstVisibleOrderKey;
    }
    ...
    public void clearVisibleInstances() {
        ...
        this.firstVisibleOrderKey = Long.MAX_VALUE;
        this.visibleRevision++;
    }
    ...
    /**
     * Apply visibility ordering metadata generated by merged container.
     */
    public void setVisibilityMeta(long firstVisibleOrderKey, long visibleRevision) {
        this.firstVisibleOrderKey = firstVisibleOrderKey;
