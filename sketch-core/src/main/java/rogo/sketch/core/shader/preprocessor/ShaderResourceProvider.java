...
public interface ShaderResourceProvider {
     ...
     */
    static ShaderResourceProvider fromGenericProvider(Function<KeyId, Optional<InputStream>> genericProvider) {
        return new ShaderResourceProvider() {
            ...
            private Optional<String> loadFromPath(KeyId keyId, String pathPrefix) {
                ...
                Optional<InputStream> inputStreamOpt = genericProvider.apply(resourcePath);
