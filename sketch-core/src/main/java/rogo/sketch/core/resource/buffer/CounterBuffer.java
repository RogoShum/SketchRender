...
public class CounterBuffer implements DataResourceObject {
    ...
    private final DataType counterType;

    private ByteBuffer mappedBuffer;

    private CounterBuffer(DataType type, boolean persistent) {
    ...
    public CounterBuffer(DataType type) {
        this(type, false);
    }

    public static CounterBuffer makePersistent(DataType type) {
