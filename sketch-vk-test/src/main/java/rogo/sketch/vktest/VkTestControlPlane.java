...
final class VkTestControlPlane implements AutoCloseable {
    ...
    private void ensureInitialized() {
        ...
        windowHandle = GLFW.glfwCreateWindow(
                ...
                "Sketch vk-test Control Plane",
                MemoryUtil.NULL,
                MemoryUtil.NULL);
        if (windowHandle == MemoryUtil.NULL) {
            throw new IllegalStateException("Failed to create vk-test control plane window");
        }
    ...
    private void drawPanels() {
        ...
        ImGui.begin("vk-test Control Plane", ImGuiWindowFlags.NoCollapse);
        ...
        ImGui.textWrapped("The main vk-test window shows the live inspection strip for source depth, frozen snapshot, linearized snapshot preview, published HiZ, and async offscreen color.");
        ImGui.separator();
