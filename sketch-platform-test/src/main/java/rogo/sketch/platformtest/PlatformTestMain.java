...
public final class PlatformTestMain {
    private static final KeyId TERRAIN_SMOKE_STAGE_ID = KeyId.of("sketch_platformtest:terrain_mesh_smoke_stage");
    private static final KeyId TERRAIN_SMOKE_SHADER_ID = KeyId.of("sketch_platformtest:terrain_mesh_smoke_shader");
    private static final KeyId TERRAIN_SMOKE_MESH_BUFFER_ID = KeyId.of("sketch_platformtest:terrain_mesh_smoke_mesh_buffer");
    private static final KeyId TERRAIN_SMOKE_REGION_INDEX_ID = KeyId.of("sketch_platformtest:terrain_mesh_smoke_region_index");
    private static final KeyId TERRAIN_SMOKE_INDIRECT_ID = KeyId.of("sketch_platformtest:terrain_mesh_smoke_indirect");
    private static final KeyId TERRAIN_SMOKE_CULL_COUNTER_ID = KeyId.of("sketch_platformtest:terrain_mesh_smoke_cull_counter");
    private static final KeyId TERRAIN_SMOKE_ELEMENT_COUNTER_ID = KeyId.of("sketch_platformtest:terrain_mesh_smoke_element_counter");
    private static final KeyId TERRAIN_SMOKE_READBACK_ID = KeyId.of("sketch_platformtest:terrain_mesh_smoke_readback");
    ...
    public static void main(String[] args) {
        ...
        PlatformTestMainWindowControlSurface controlSurface = null;
        try {
            ...
            PlatformTestPresentationController presentationController = new PlatformTestPresentationController();
            ...
            GraphicsDriver.bootstrap(
                    backendKind,
                    new BackendBootstrapContext("sketch-platform-test", window, windowService, presentationController));
            GraphicsDriver.threadContext().registerMainThread();
            EventBusBridge.setImplementation(new PlatformTestEventBusImplementation());
            ...
            if (controlPlaneEnabled) {
                controlSurface = new PlatformTestMainWindowControlSurface(window, windowService, presentationController, backendKind, scene);
            }
    ...
    private static final class PlatformTestMainWindowControlSurface implements AutoCloseable {
        ...
        private PlatformTestMainWindowControlSurface(
                long windowHandle,
        ...
        private void triggerProfilerCapture() {
            ...
            SimpleProfiler.get().startRecording(5.0, file -> {
                ...
                if (file != null) {
                    SketchDiagnostics.get().info("platform-test-profiler", "Saved SimpleProfiler trace to " + file.getAbsolutePath());
                } else {
                    SketchDiagnostics.get().warn("platform-test-profiler", "SimpleProfiler capture finished without an output file");
                }
            });
        }
    ...
    private static final class PlatformTestPresentationController implements PresentationController {
        @Override
