...
public class OptimizedRenderingExample {
    ...
    private static void demonstrateVertexResourceSharing() {
        ...
        try {
            VertexResource resource1 = manager.getOrCreateVertexResource(setting1.renderParameter());
            VertexResource resource2 = manager.getOrCreateVertexResource(setting2.renderParameter());
