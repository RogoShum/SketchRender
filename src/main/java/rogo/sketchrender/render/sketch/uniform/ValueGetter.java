...
public class ValueGetter<T> {
    private final BiFunction<Object, Identifier, T> valueGetter;
    ...
    public ValueGetter(BiFunction<Object, Identifier, T> valueGetter, Class<T> clazz) {
    ...
    public static <T> ValueGetter<T> create(BiFunction<Object, Identifier, T> value, Class<T> clazz) {
        return new ValueGetter<>(value, clazz);
    }

    public T get(Object graph, Identifier identifier) {
