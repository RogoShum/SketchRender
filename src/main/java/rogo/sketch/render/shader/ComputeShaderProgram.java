...
public class ComputeShaderProgram implements ShaderCollector, ExtraUniform, ShaderProvider {
    ...
    public ComputeShaderProgram(ResourceProvider resourceProvider, ResourceLocation shaderLocation) throws IOException {
