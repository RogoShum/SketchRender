...
public class DefaultDataFormats {
    ...
    public static final DataFormat POSITION_UV_NORMAL = DataFormat.builder("position_uv_normal").vec3Attribute("position").vec2Attribute("uv").add("normal", DataType.VEC3F, true).build();
