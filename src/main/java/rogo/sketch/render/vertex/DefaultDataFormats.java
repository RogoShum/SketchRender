...
public class DefaultDataFormats {
    ...
    public static final DataFormat POSITION_UV_NORMAL = DataFormat.builder("position_uv_normal").vec3Attribute("position").add("uv", DataType.VEC2F, true).add("normal", DataType.VEC3S, true).build();
    ...
    public static final DataFormat OBJ = DataFormat.builder("obj").vec3Attribute("position").add("uv", DataType.VEC2F, true).add("normal", DataType.VEC3S, true).build();
}