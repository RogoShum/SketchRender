...
import rogo.sketch.core.data.builder.IndexWriteBuffer;
 ...
 */
public class OpenGLIndexBuffer implements BufferResourceObject {
    protected int id;
    ...
    protected IndexWriteBuffer builder;
    ...
    public OpenGLIndexBuffer(boolean shared) {
    ...
    public void upload() {
        ...
        if (builder == null) {
            builder = new IndexWriteBuffer(4L);
        }
